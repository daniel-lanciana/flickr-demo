...
* Deploy Heroku
* Rdoc
* Functional programming sweep
* Zero results use case
* Integration test using working API
* Cleanup files (e.g. old controller and generated tests)
* Run all RSpec tests in one go
* Tests:
 * RSpec: thumbnail IMG tags
 * RSpec: pagination
 * RSpec: thumbnail to large photo
 * Unit test: url_t method
 * unit test: API call (e.g. page 1)
